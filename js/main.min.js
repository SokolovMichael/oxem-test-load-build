...
/*!*****************************!*\
  !*** ./js/calculate-all.js ***!
  \*****************************/
/*! exports provided: calculateAll */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "calculateAll", function() { return calculateAll; });
var sum = document.querySelector('.sum');
var inputAnInitialFeeRublesResult = sum.querySelector('.sum__input--an-initial-fee-rubles');
var inputPrice = sum.querySelector('.sum__input--price');
var sliderAnInitialFee = sum.querySelector('.sum__item-slider--an-initial-fee');
var inputAnInitialFee = sum.querySelector('.sum__input--an-initial-fee-percent');
var sliderPrice = sum.querySelector('.sum__item-slider--price');
var sliderLeasingTerm = sum.querySelector('.sum__item-slider--leasing-term');
var inputLeasingTerm = sum.querySelector('.sum__input--leasing-term');
var total = document.querySelector('.total');
var totalMonthlyPayment = total.querySelector('.total__input--monthly-payment');
var totalLeaseAgreement = total.querySelector('.total__input--lease-agreement');

var calculateAll = function calculateAll() {
  sliderPrice.noUiSlider.on('update', function (values, handle) {
    var inputPriceNumber = Math.round(values[handle]) * 1;
    var inputPriceText = inputPriceNumber.toLocaleString();
    inputPrice.value = inputPriceText;
    var inputPriceCalculation = Number(inputPrice.value.replace(/\s/g, ''));
    sliderAnInitialFee.noUiSlider.on('update', function (valuesAnInitialFee, handleAnInitialFee) {
      inputAnInitialFee.value = Math.round(valuesAnInitialFee[handleAnInitialFee]);
      var inputAnInitialFeeRublesResultNumber = inputPriceCalculation * inputAnInitialFee.value / 100;
      var inputAnInitialFeeRublesResultText = inputAnInitialFeeRublesResultNumber.toLocaleString();
      inputAnInitialFeeRublesResult.value = inputAnInitialFeeRublesResultText;
      sliderLeasingTerm.noUiSlider.on('update', function (valuesLeasingTerm, handleLeasingTerm) {
        inputLeasingTerm.value = Math.round(valuesLeasingTerm[handleLeasingTerm]);
        var months = inputLeasingTerm.value;
        var monthPay = Math.round((inputPriceCalculation - inputAnInitialFeeRublesResultNumber) * (0.035 * Math.pow(1 + 0.035, months) / (Math.pow(1 + 0.035, months) - 1)));
        var monthPayText = monthPay.toLocaleString();
        totalMonthlyPayment.value = monthPayText;
        var totalSum = inputAnInitialFeeRublesResultNumber + months * monthPay;
        var totalSumText = totalSum.toLocaleString();
...
/***/ "./js/draw-slider-an-initial-fee.js":
/*!******************************************!*\
  !*** ./js/draw-slider-an-initial-fee.js ***!
  \******************************************/
/*! exports provided: drawSliderAnInitialFee */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "drawSliderAnInitialFee", function() { return drawSliderAnInitialFee; });
/* harmony import */ var _nouislider_nouislider_min__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./nouislider/nouislider.min */ "./js/nouislider/nouislider.min.js");
/* harmony import */ var _nouislider_nouislider_min__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_nouislider_nouislider_min__WEBPACK_IMPORTED_MODULE_0__);

var sum = document.querySelector('.sum');
var sliderAnInitialFee = sum.querySelector('.sum__item-slider--an-initial-fee');
var inputAnInitialFee = sum.querySelector('.sum__input--an-initial-fee-percent');
var inputs = [inputAnInitialFee];

var initSliderAnInitialFee = function initSliderAnInitialFee() {
  _nouislider_nouislider_min__WEBPACK_IMPORTED_MODULE_0___default.a.create(sliderAnInitialFee, {
    start: 10,
    connect: 'lower',
    step: 1,
    range: {
...
var initRangeSliderAnInitialFee = function initRangeSliderAnInitialFee(i, value) {
  var array = [null, null];
  array[i] = value;
  sliderAnInitialFee.noUiSlider.set(array);
};

var drawSliderAnInitialFee = function drawSliderAnInitialFee() {
...
/***/ "./js/draw-slider-leasing-term.js":
/*!****************************************!*\
  !*** ./js/draw-slider-leasing-term.js ***!
  \****************************************/
/*! exports provided: drawSliderLeasingTerm */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "drawSliderLeasingTerm", function() { return drawSliderLeasingTerm; });
/* harmony import */ var _nouislider_nouislider_min__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./nouislider/nouislider.min */ "./js/nouislider/nouislider.min.js");
/* harmony import */ var _nouislider_nouislider_min__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_nouislider_nouislider_min__WEBPACK_IMPORTED_MODULE_0__);
...
var sliderLeasingTerm = sum.querySelector('.sum__item-slider--leasing-term');
var inputLeasingTerm = sum.querySelector('.sum__input--leasing-term');
var inputs = [inputLeasingTerm];

var initSliderLeasingTerm = function initSliderLeasingTerm() {
  _nouislider_nouislider_min__WEBPACK_IMPORTED_MODULE_0___default.a.create(sliderLeasingTerm, {
    start: 60,
    connect: 'lower',
    step: 1,
    range: {
...
var initRangeSliderLeasingTerm = function initRangeSliderLeasingTerm(i, value) {
  var array = [null, null];
  array[i] = value;
  sliderLeasingTerm.noUiSlider.set(array);
};

var drawSliderLeasingTerm = function drawSliderLeasingTerm() {
...
/***/ "./js/draw-slider-price.js":
/*!*********************************!*\
  !*** ./js/draw-slider-price.js ***!
  \*********************************/
/*! exports provided: drawSliderPrice */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "drawSliderPrice", function() { return drawSliderPrice; });
/* harmony import */ var _nouislider_nouislider_min__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./nouislider/nouislider.min */ "./js/nouislider/nouislider.min.js");
/* harmony import */ var _nouislider_nouislider_min__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_nouislider_nouislider_min__WEBPACK_IMPORTED_MODULE_0__);
...
var sliderPrice = sum.querySelector('.sum__item-slider--price');
var inputPrice = sum.querySelector('.sum__input--price');
var inputs = [inputPrice];

var initSliderPrice = function initSliderPrice() {
  _nouislider_nouislider_min__WEBPACK_IMPORTED_MODULE_0___default.a.create(sliderPrice, {
    start: 3300000,
    connect: 'lower',
    step: 10000,
    range: {
...
var initRangeSliderPrice = function initRangeSliderPrice(i, value) {
  var array = [null, null];
  array[i] = value;
  sliderPrice.noUiSlider.set(array);
};

var drawSliderPrice = function drawSliderPrice() {
  if (sliderPrice) {
    initSliderPrice();
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _input_number_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./input-number.js */ "./js/input-number.js");
/* harmony import */ var _draw_slider_price_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./draw-slider-price.js */ "./js/draw-slider-price.js");
/* harmony import */ var _draw_slider_an_initial_fee_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./draw-slider-an-initial-fee.js */ "./js/draw-slider-an-initial-fee.js");
/* harmony import */ var _draw_slider_leasing_term_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./draw-slider-leasing-term.js */ "./js/draw-slider-leasing-term.js");
/* harmony import */ var _calculate_all_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./calculate-all.js */ "./js/calculate-all.js");
/* harmony import */ var _send_data_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./send-data.js */ "./js/send-data.js");
...
Object(_input_number_js__WEBPACK_IMPORTED_MODULE_0__["inputNumber"])();
Object(_draw_slider_price_js__WEBPACK_IMPORTED_MODULE_1__["drawSliderPrice"])();
Object(_draw_slider_an_initial_fee_js__WEBPACK_IMPORTED_MODULE_2__["drawSliderAnInitialFee"])();
Object(_draw_slider_leasing_term_js__WEBPACK_IMPORTED_MODULE_3__["drawSliderLeasingTerm"])();
Object(_calculate_all_js__WEBPACK_IMPORTED_MODULE_4__["calculateAll"])();
Object(_send_data_js__WEBPACK_IMPORTED_MODULE_5__["sendData"])();
...
/* harmony import */ var _utils_debounce_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./utils/debounce.js */ "./js/utils/debounce.js");
/* harmony import */ var _utils_is_enter_key_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./utils/is-enter-key.js */ "./js/utils/is-enter-key.js");


var form = document.querySelector('.form');
var formButton = form.querySelector('.form__wrapper').querySelector('button');
var formText = formButton.querySelector('.form__text');
var formLoad = formButton.querySelector('.form__load');
var onSendDataDebounce = Object(_utils_debounce_js__WEBPACK_IMPORTED_MODULE_0__["debounce"])(function () {
  form.submit();
});

var initLoadingButton = function initLoadingButton() {
  formText.classList.add('form__text--loading');
  formLoad.classList.add('form__load--loading');
};

var initSendData = function initSendData() {
...
var sendData = function sendData() {
  ...
  var onEnterKeydown = function onEnterKeydown(evt) {
    if (Object(_utils_is_enter_key_js__WEBPACK_IMPORTED_MODULE_1__["isEnterKey"])(evt)) {
      evt.preventDefault();
      initSendData();
    }
  };
...
function debounce(callback) {
  ...
  var timeoutDelay = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 2000;
  var timeoutId;
  return function () {
    ...
    clearTimeout(timeoutId); // eslint-disable-next-line no-invalid-this
...
/***/ "./js/utils/is-enter-key.js":
/*!**********************************!*\
  !*** ./js/utils/is-enter-key.js ***!
  \**********************************/
/*! exports provided: isEnterKey */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
